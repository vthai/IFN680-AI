...
'''
    If no card has been flipped, flipping at any position can be a King with a probability of 1/3 = 0.3333
'''
print '\nIf no card has been flipped, flipping at any position can be a King with a probability of 1/3 = 0.3333'
...
'''
    If after second card has been flipped and it is still not a King, then the probability of any second card flipped being a King is further definite (P=1)
'''
print '\nIf after the second card has been flipped and it is still not a King, then the probability of any third card flipped being a King is definite (P=1)'
...
print '\nIf a card has been flipped and it is a King, then the probability of any second card flipped being a King is None (P=0)'
p_King = enumerate_joint_ask('Card3', {'Card2':True}, cards)
print 'P(C3=T|C2=T) =', p_King[True], ',P(C3=F|C2=T) =', p_King[False]

print '\nIf two card has been flipped and one is king, one is not, then the probability of any third card flipped being a King is none (P=0)'
p_King = enumerate_joint_ask('Card3', {'Card2':True, 'Card4': True}, cards)
print 'P(C3=T|C2=T,C4=F) =', p_King[True], ',P(C3=F|C2=T,C4=F) =', p_King[False]
